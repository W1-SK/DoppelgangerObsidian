...
## O projektu
D&D Toolbox vzniká z potřeby sjednotit veškeré české nástroje pro D&D 5e  Čarotéka
...
- [@oneiros26](https://github.com/oneiros26)
 ...
 na jednom místě. Jako hráč a DM jsem si uvědomil, že hledání spolehlivých lokalizovaných materiálů a rychlých utilit na různých webech zpomaluje hru i přípravu. Tento projekt má ambici stát se vaší “centrálou” pro vše, co potřebujete:
...
### Hráč
- Knihovna kouzel
	- Tvorba vlastních knih kouzel
	- Přehledné zobrazení kouzel v češtině
- Tahák pro boj
	- Jednoduše použitelný
	- Skvělé pro začátečníky
- Deník postavy
	- Tvoření a spravování vlastních deníků postavy
	- Přehledné zobrazení deníků postavy
	- Napojení na databázi
### Pán jeskyně
- Generátory
	- Pokladů: nastavení náročnosti střetů, magických předmětu...
	- Obchodů: automatické ceny a zbožní v obchodě
- Soundboard
	- Hudba do pozadí
	- Zvukové efekty
### Svět
